...
For Sequelize types, model base class, and data type helpers:
...
- [ESLint Configuration](../eslint/README.md) - Configuring linting rules
- [Service Adapter Pattern](../service/service-adapter-pattern.md) - Building adapters

---

**Next:** [Third-Party Overview](./README.md) | [Repository README](../../README.md)
