...
- **[Server Platform API →](./README.md)** - Complete server platform reference

---

## Related

- [Server Platform API](./README.md) - HTTP servers, page servers, and databases
- [Configuration](../configuration/README.md) - Full configuration reference
- [Errors](../error/README.md) - Error handling

---

**Next**: [Server Platform API →](./README.md)
