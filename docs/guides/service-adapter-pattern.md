...
- `examples/platform-express/02-with-mongodb/src/index.ts`
- `examples/platform-fastify/01-with-sqlite/src/index.ts`
- `examples/platform-fastify/02-with-mongodb/src/index.ts`
