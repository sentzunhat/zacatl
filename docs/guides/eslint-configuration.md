...
- [Hexagonal Architecture Guide](./infrastructure-usage.md)
- [Layer Registration Guide](./layer-registration.md)
- [Naming Conventions Standard](../standards/naming-conventions-guide.md)
