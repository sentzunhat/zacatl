...
// package.json
{
  "exports": {
    ...
    "./orm/mongoose": "./build/orm/mongoose.js", // Opt-in Mongoose
    "./orm/sequelize": "./build/orm/sequelize.js" // Opt-in Sequelize
  }
}
```
...
```typescript
// src/service/architecture/infrastructure/repositories/types.ts
...
```typescript
// src/service/architecture/infrastructure/orm/adapter-loader.ts
...
// Import from: @sentzunhat/zacatl/orm/mongoose
```
...
```typescript
// src/service/architecture/infrastructure/index.ts
...
// - @sentzunhat/zacatl/orm/mongoose
// - @sentzunhat/zacatl/orm/sequelize
```
