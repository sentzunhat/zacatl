...
```typescript
// src/micro-service/architecture/infrastructure/orm/adapters/your-adapter.ts
...
```typescript
// src/micro-service/architecture/infrastructure/repositories/types.ts
...
```typescript
// src/micro-service/architecture/infrastructure/repositories/abstract.ts
...
```typescript
// src/micro-service/architecture/infrastructure/orm/index.ts
...
- New: `src/micro-service/architecture/infrastructure/orm/`
  - `adapters/` (mongoose-adapter.ts, sequelize-adapter.ts)
  - `orm-registry.ts`
  - `orm-adapter.interface.ts`
- Keep: `repositories/` (existing, still working)

### Phase 2: Deprecate Old Pattern

- Mark BaseRepository as `@deprecated`
- Update docs to point to new pattern
- No breaking changes yet

### Phase 3: Gradual Migration

- New repositories use `ORMAdapter` pattern
- Old code can coexist
- Tests updated incrementally

### Phase 4: Cleanup

- Remove old pattern (v1.0)
