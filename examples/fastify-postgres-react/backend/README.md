...
# Zacatl Fastify + PostgreSQL Backend

Minimal Fastify backend for the Fastify + PostgreSQL + React example.
...
- Default DB URL: postgres://local:local@localhost:5432/appdb

## Environment

- PORT (default: 8083)
- DATABASE_URL (default: postgres://local:local@localhost:5432/appdb)
...
- Compare DB adapter differences vs MongoDB and SQLite examples
