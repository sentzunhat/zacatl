...
docker build --build-arg EXAMPLE=express-postgres-react \
  -f examples/Dockerfile -t zacatl-express-postgres-react .
...
Compare with [Express + MongoDB + React](../express-mongodb-react/) for document workflows.
