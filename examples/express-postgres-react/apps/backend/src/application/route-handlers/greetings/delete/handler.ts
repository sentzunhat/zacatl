...
import { DeleteRouteHandler } from '@sentzunhat/zacatl/service/layers/application/entry-points/rest/express/handlers/delete-route-handler';
...
export class DeleteGreetingHandler extends DeleteRouteHandler<void, void, { success: boolean }, GreetingIdParams> {
  ...
  async handler(request: Request<GreetingIdParams, { success: boolean }, void, void>): Promise<{ success: boolean }> {
