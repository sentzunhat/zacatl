<!--
/**
 * Express + SQLite Greetings Example (Svelte)
 *
 * Demonstrates a Svelte 5 frontend with the Zacatl Express backend.
...
<main class="mx-auto flex min-h-screen max-w-5xl flex-col gap-6 px-6 py-10">
  <header class="flex flex-col gap-2">
    ...
    >
      Zacatl Express Example
    </p>
    <h1 class="text-3xl font-semibold text-slate-900">
      Express + SQLite Greetings (Svelte)
    </h1>
