# Zacatl Fastify + MongoDB Backend

Minimal Fastify backend for the Fastify + MongoDB + React example.
...
- Default Mongo URI: mongodb://localhost:27017/greetings-db

## Environment

- PORT (default: 8082)
- MONGO_URI (default: mongodb://localhost:27017/greetings-db)
