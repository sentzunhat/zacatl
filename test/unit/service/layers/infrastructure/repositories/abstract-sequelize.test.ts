...
import { SequelizeRepository } from '../../../../../../src/service/layers/infrastructure/repositories/sequelize';
...
class UserRepository extends SequelizeRepository<MockModel, UserInput, UserOutput> {
  constructor() {
    super({ type: ORMType.Sequelize, name: MODEL_NAME });
  }
}

describe('AbstractSequelizeRepository', () => {
