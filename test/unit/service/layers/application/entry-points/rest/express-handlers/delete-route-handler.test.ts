...
import { DeleteRouteHandler } from '../../../../../../../../src/service/layers/application/entry-points/rest/express/handlers/delete-route-handler';
...
class TestDeleteRouteHandler extends DeleteRouteHandler<
  void,
...
describe('Express DeleteRouteHandler', () => {
  it('should send the handler response when execute succeeds', async () => {
    const handler = new TestDeleteRouteHandler({ url: '/delete-test', schema: {} });
