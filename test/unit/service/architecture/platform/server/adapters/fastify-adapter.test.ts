...
import { FastifyAdapter } from "../../../../../../../src/service/architecture/platform/server/adapters/fastify-adapter";
import {
  RouteHandler,
  HookHandler,
...
describe("FastifyAdapter", () => {
  ...
  beforeEach(() => {
    ...
    adapter = new FastifyAdapter(mockServer);
  });
  ...
  describe("serveStatic", () => {
    it("should serve static files from a directory", () => {
      const serveStaticSpy = vi.fn();
      mockServer.register = serveStaticSpy;
      ...
      expect(serveStaticSpy).toHaveBeenCalled();
    });

    it("should serve static files with custom prefix", () => {
      const serveStaticSpy = vi.fn();
      mockServer.register = serveStaticSpy;
