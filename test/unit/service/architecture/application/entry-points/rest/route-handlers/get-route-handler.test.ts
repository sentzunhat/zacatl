...
import { GetRouteHandler } from "../../../../../../../../src/service/architecture/application/entry-points/rest/route-handlers/get-route-handler";
import {
  createFakeFastifyReply,
  createFakeFastifyRequest,
} from "../../../../../../helpers/common/common";
import { Request } from "../../../../../../../../src/service/architecture/application";
