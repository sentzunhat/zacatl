 ...
 */
const recommended = [baseConfig, importsConfig, namingConventions, fileNamingRules];

// Named exports for granular control
export { baseConfig, importsConfig, namingConventions, fileNamingRules, recommended };
