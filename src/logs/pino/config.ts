import type { PinoLoggerConfig, PinoConfigOptions } from './types';
 ...
 * @returns Pino logger options ready to be passed to `pino()`
 *
 * @example Basic usage
 * ```typescript
 ...
 * ```
 */
export const createPinoConfig = (options?: PinoConfigOptions): PinoLoggerConfig => {
