...
import type { RouteHandler } from './entry-points/rest/fastify/handlers/route-handler';
import type { HookHandler } from './entry-points/rest/hook-handlers/hook-handler';
