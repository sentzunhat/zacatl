...
/**
 * Creates a Sequelize adapter using a lazy-loading wrapper.
 *
 * Defers importing the real Sequelize adapter until the adapter is actually
 * used. This keeps bundlers from traversing the Sequelize implementation and
 * its heavy runtime deps when unused.
 *
 * @param config Sequelize repository configuration
 * @returns ORMPort lazy-loading implementation for Sequelize
 */
