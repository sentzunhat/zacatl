 ...
 *
 * This adapter wraps Sequelize model operations and provides a consistent
 * interface for the repository layer. It handles plain object transformation,
 * ID normalization, and timestamp management.
 */
export class SequelizeAdapter<D extends Model, I, O> implements ORMAdapter<
  D,
  I,
  O
> {
