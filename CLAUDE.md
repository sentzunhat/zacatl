...
Claude Code rules under `.claude/rules/hawp-*.md` provide scoped HAWP behavior. See `.hawp/kit/references/backlog-alignment.md` for backlog compaction policy.
...
<!-- Add project-specific build commands, coding standards, and Claude Code instructions below. -->
