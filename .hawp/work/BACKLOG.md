...
| `4b7e2c91`   | bugfix      | P2: NodeNext declaration-barrel compatibility for packed consumers             | plan-ready  | `.hawp/work/active/4b7e2c91-nodenext-declaration-barrels.md` |
